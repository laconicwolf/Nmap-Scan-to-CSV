...
def print_web_ports(data):
    ...
    http_port_list = ['80', '81', '591', '593', '2080', '2480' '3080', 
                      ...
                      '7001', '7080', '7777', '8000', '8008', '8042',
                      '8080', '8081', '8082', '8088', '8180', '8222', 
                      '8280', '8281', '8530', '8887', '9000', '9080',
                      '9090', '16080']                    
    https_port_list = ['832', '981', '1311', '7002', '7021', '7023',
                       '7025', '7777', '8333', '8531','8888']
